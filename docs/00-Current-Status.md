...
- Subscription no tiene implementación backend en el baseline. Rolo delegó una recomendación provisional: TOP Inicial, cupo de 10 Resources operativos y solicitud de ampliación persistida para revisión, sin billing. Pendiente de implementación y validación; reglas precisas en el próximo épico.
