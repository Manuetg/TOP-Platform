...
- FE-FND-004 — In Progress: boundaries de página y respaldo general implementados; recuperación explícita, guards Auth/Business y errores API locales preservados. Tests sobre rutas productivas; evidencia CI pendiente en la misma PR. QA manual: NOT RUN.
