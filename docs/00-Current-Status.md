...
Estado:
- FE-PAY-002 — In Progress sobre `develop@5369471`. Registro manual inline desde Booking con idempotencia recuperable por pestaña; no hay consulta pública por clave ni deduplicación entre sesiones u operadores. QA interactiva: NOT RUN por decisión de Rolo.
...
- 45/52 historias frontend activas Completed; 1 In Progress, 6 Planned y 0 Blocked.
