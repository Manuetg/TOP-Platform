...
describeWithPostgres('PrismaRatePlanRepository', () => {
  ...
  it('protects existing seasons when reducing validity and preserves the RatePlan atomically', async () => {
    ...
    expect(unchanged).toMatchObject({ baseNightlyAmountMinor: 450000n, validFrom: new Date('2026-12-20T00:00:00.000Z'), validTo: new Date('2027-01-06T00:00:00.000Z') });
