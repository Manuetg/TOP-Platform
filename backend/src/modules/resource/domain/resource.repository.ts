...
export interface ResourceRepository { findByBusinessAndCode(businessId: string, internalCode: string): Promise<Resource | null>; create(data: CreateResourceData): Promise<Resource>; }
