...
describe('ListResourcesUseCase', () => {
  ...
  const useCase = new ListResourcesUseCase({ findById, create: jest.fn(), list: jest.fn(), update: jest.fn() }, { findByBusinessAndCode: jest.fn(), findByIdAndBusinessId: jest.fn(), listByBusinessId, create: jest.fn(), update: jest.fn() });
