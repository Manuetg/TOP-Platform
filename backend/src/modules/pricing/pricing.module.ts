...
@Module({ imports: [BusinessModule, ResourceModule], controllers: [PricingController], providers: [PrismaRatePlanRepository, PrismaSeasonalRateRepository, { provide: RATE_PLAN_REPOSITORY, useExisting: PrismaRatePlanRepository }, { provide: SEASONAL_RATE_REPOSITORY, useExisting: PrismaSeasonalRateRepository }, { provide: PRICING_RESOURCE_LOOKUP, useExisting: RESOURCE_REPOSITORY }, CreateRatePlanUseCase, UpdateRatePlanUseCase, CreateSeasonalRateUseCase, ListSeasonalRatesUseCase] }) export class PricingModule {}
