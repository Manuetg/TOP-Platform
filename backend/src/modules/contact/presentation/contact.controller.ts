...
export class ContactController {
  ...
  @Post() @HttpCode(HttpStatus.CREATED) @ApiOperation({ summary: 'Creates a contact for a business.' }) @ApiCreatedResponse({ type: ContactResponseDto }) @ApiBadRequestResponse() @ApiNotFoundResponse() @ApiConflictResponse()
  ...
  @Get() @ApiOperation({ summary: 'Searches contacts by name, phone, WhatsApp, email or document.' }) @ApiOkResponse({ type: ContactResponseDto, isArray: true }) @ApiBadRequestResponse() @ApiNotFoundResponse()
  ...
  @Get(':contactId') @ApiOperation({ summary: 'Gets a contact scoped to its business.' }) @ApiOkResponse({ type: ContactResponseDto }) @ApiBadRequestResponse() @ApiNotFoundResponse()
  ...
  @Patch(':contactId') @ApiOperation({ summary: 'Updates a contact partially without changing its business.' }) @ApiOkResponse({ type: ContactResponseDto }) @ApiBadRequestResponse() @ApiNotFoundResponse() @ApiConflictResponse()
