...
export interface BookingRepository {
  ...
  markPending(id: string, businessId: string, actorUserId: string | null): Promise<Booking | null>;
  markCancelled(id: string, businessId: string, actorUserId: string | null, reason?: string): Promise<Booking | null>;
