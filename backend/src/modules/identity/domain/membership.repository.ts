...
export interface MembershipRepository {
  findByUserAndBusiness(userId: string, businessId: string): Promise<UserBusinessMembership | null>;
  findByUserId(userId: string): Promise<UserBusinessMembership[]>;
  create(data: { userId: string; businessId: string; role: MembershipRole }): Promise<UserBusinessMembership>;
}
