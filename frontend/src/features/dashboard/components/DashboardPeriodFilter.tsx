    ...
    >
      <div className="dashboard-period__controls">
        <Input
          ...
          aria-describedby="dashboard-period-help dashboard-period-error"
      ...
      <p id="dashboard-period-help">
        Hasta no incluido · Máximo 31 días · Fechas del negocio
      </p>
      <div id="dashboard-period-error" role={error ? "alert" : undefined}>
        {error}
      </div>
    </form>
  );
