...
const tenantPrefixes = ["resources", "amenities", "contacts", "bookings", "blocks", "dashboard", "seasonal-rates", "rate-plans", "availability", "payments", "global-search", "payment-history", "outstanding-balance", "business-profile", "subscription"];
